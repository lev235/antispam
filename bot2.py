...
BAD_WORDS = {
    ...
    "залупа", "уеб", "пидор", "чмо", "мразь", "жопа", "мудило", "пиши", "пишите", "в личные сообщения", "писать", "заработать", "заработком", "заработки", "заработай" "бюджет", "плачу", "платим"
}
AD_KEYWORDS = {"работа", "деньги", "заработок", "@", "t.me", "в лс", "+7", "8-9", "https://"}
FLOOD_LIMIT = 3
